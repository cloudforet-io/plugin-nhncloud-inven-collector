...
from plugin.connector.network_acl.rule_connector import NACLRulesConnector
...
class RuleManager(NHNCloudBaseManager):
    ...
    def create_cloud_service(self, secret_data):
        rules_connector = NACLRulesConnector()
        for AVAILABLE_REGION in self.AVAILABLE_REGIONS:
            resources = rules_connector.get_nacl_rules(secret_data, AVAILABLE_REGION)
