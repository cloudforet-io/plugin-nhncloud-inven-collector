...
from plugin.connector.loadbalancer.ip_acl_connector import LoadBalancerIpACLConnector
from plugin.manager.base import NHNCloudBaseManager

_LOGGER = logging.getLogger("cloudforet")


class LoadBalancerIpACLManager(NHNCloudBaseManager):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.cloud_service_type = "IP ACL"
        self.provider = "nhncloud"
        self.metadata_path = "metadata/loadbalancer/ipacl.yaml"
    ...
    def create_cloud_service(self, secret_data):
        ip_acl_connector = LoadBalancerIpACLConnector()
        for AVAILABLE_REGION in self.AVAILABLE_REGIONS:
            resources = ip_acl_connector.get_ip_acls(secret_data, AVAILABLE_REGION)
