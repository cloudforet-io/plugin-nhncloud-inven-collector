...
from plugin.connector.image.image_connector import ImageConnector
...
class ImageManager(NHNCloudBaseManager):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.metadata_path = "metadata/image/image.yaml"
    ...
    def create_cloud_service_type(self):
        cloud_service_type = make_cloud_service_type(
            ...
            is_major=True,
            tags={
                "spaceone:icon": f"{ASSET_URL}/image.png"
            },
            labels=["Compute"]
        )
    ...
    def create_cloud_service(self, secret_data):
        ...
        for AVAILABLE_REGION in self.AVAILABLE_REGIONS:
            resources = image_connector.get_image(secret_data, AVAILABLE_REGION)
