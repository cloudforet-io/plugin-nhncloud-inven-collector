...
from plugin.connector.rds_for_mariadb.db_instance_connector import DBInstanceConnector
    ...
    def create_cloud_service(self, secret_data):
        ...
        for AVAILABLE_REGION in self.AVAILABLE_REGIONS:
            ...
            for db_instance in db_instances:
                reference = {
                    "resource_id": db_instance.get("dbInstances"),
                    "external_link": ""
                }
                
                cloud_service = make_cloud_service(
                    name=db_instance["dbInstanceId"],
