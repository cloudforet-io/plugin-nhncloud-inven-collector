...
from plugin.connector.vpc.subnet_connector import VPCSubnetConnector
from plugin.manager.base import NHNCloudBaseManager

_LOGGER = logging.getLogger("cloudforet")


class VPCSubnetManager(NHNCloudBaseManager):
    ...
    def create_cloud_service(self, secret_data):
        subnet_connector = VPCSubnetConnector()
        for AVAILABLE_REGION in self.AVAILABLE_REGIONS:
            resources = subnet_connector.get_subnet(secret_data, AVAILABLE_REGION)
